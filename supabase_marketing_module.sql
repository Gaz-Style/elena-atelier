...
('Programmatic SEO de Alta Conversión', 'Generación masiva de cientos de páginas internas dinámicas ultra-optimizadas ("Vestidos de novia de raso de seda en Vitacura", etc.)', 'SEO & GEO', 'pending', 'Oct-2026', 'Alto'),
('Flujos de Correo Enriquecidos (Smart Welcome Flows)', 'Conectar formularios a Supabase Edge Functions usando Resend para perfiles hiper-personalizados según el background del lead.', 'Automatización CRM', 'pending', 'Oct-2026', 'Alto'),
('Publicidad por Geocercas (Geofencing Ads)', 'Configurar Meta Ads y Google Ads de radio ultra-acotado (1 a 2 km) en centros comerciales y residenciales exclusivos.', 'Meta Ads', 'pending', 'Nov-2026', 'Alto'),
('Tarjetas de Bienvenida Físicas VIP (QR Tracking)', 'Distribuir tarjetas impresas premium en edificios de alto valor con un código QR único conectado dinámicamente al CRM.', 'Viral Loop (Referidos)', 'pending', 'Nov-2026', 'Alto'),
('Campañas de Salida de Stock Automatizadas', 'Cron job semanal que detecte sobrestock inmovilizado y dispare alertas VIP a clientas históricas por WhatsApp.', 'Automatización CRM', 'pending', 'Dic-2026', 'Alto'),
('Newsletter Editorial "Tendencias & Alta Costura"', 'Creación de un boletín automatizado que envíe noticias, análisis de moda y curatoría estética mensual a las clientas fidelizadas.', 'Automatización CRM', 'pending', 'Ene-2027', 'Medio'),
('Asistente de Contenido IA para Redes', 'Módulo interno (AI-powered) que ayude a estructurar guiones y copys para Instagram/TikTok basados en las creaciones del taller.', 'Meta Ads', 'pending', 'Ene-2027', 'Alto');
