...
| **Microsoft Clarity** | Project ID: `yklaavgogy` | `.env.local` (`NEXT_PUBLIC_CLARITY_PROJECT_ID`) | 🟢 Conectado | Grabaciones de sesión en vivo, mapas de calor (heatmaps), clics de rabia y usabilidad UX en móvil. |
