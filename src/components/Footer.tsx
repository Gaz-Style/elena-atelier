  ...
  return (
    <footer className="w-full py-10 border-t border-transparent bg-black mt-auto relative z-10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="text-[9px] text-white/40 font-sans tracking-widest uppercase font-semibold">
          &copy; {new Date().getFullYear()} Elena La Costurera. Todos los derechos reservados.
        </div>
        <div className="flex items-center gap-6 text-[9px] text-white/40 font-sans tracking-[0.2em] uppercase font-semibold">
