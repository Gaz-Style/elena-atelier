            ...
            >
                ...
                <div className="max-w-[90vw] md:max-w-xl mx-auto border-[0.5px] border-white/[0.05] px-6 py-10 md:px-12 md:py-12 backdrop-blur-[2.5px] bg-black/[0.08] rounded-[1px] shadow-[0_8px_32px_0_rgba(0,0,0,0.25)]">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-6 px-4 mt-12 md:mt-14">
                        {/* Botón Primario: Navegación de Descubrimiento (Ver Colección) */}
                        <Link
                            href="/portafolio"
                        ...
                        >
                            <span className="glass-text relative z-10 flex items-center justify-center gap-2 whitespace-nowrap">
                                VER COLECCIÓN
                                <svg className="w-3.5 h-3.5 stroke-[#f5f2eb] group-hover:stroke-[#121212] transition-colors duration-500 transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" strokeWidth="1.5">
                        ...
                        <a
                            ...
                            className="text-white/70 hover:text-white font-sans text-[11px] uppercase tracking-[0.25em] font-medium py-3 px-6 transition-all duration-300 flex items-center gap-2 group hover:underline underline-offset-4"
                        >
                            <span>Habla con Elena</span>
                            <svg className="w-3.5 h-3.5 opacity-70 group-hover:opacity-100 transition-opacity duration-300 fill-current text-white/80 group-hover:text-white" viewBox="0 0 24 24">
