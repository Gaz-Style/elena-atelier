...
export const historiasNovias: HistoriaNovia[] = [
  {
    ...
    imagenPrincipal: '/trabajos/novias/iglesia/Sofi_novia_1.png',
    etapaAtelier: {
      ...
      imagen: '/trabajos/novias/proceso/historia_sofia_atelier.png',
    ...
    instancias: {
      civil: {
        ...
        imagen: '/trabajos/novias/civil/Ignacia_civil_1.png',
        detallesTecnicos: [
      ...
      iglesia: {
        ...
        imagen: '/trabajos/novias/iglesia/Sofi_novia_2.png',
        detallesTecnicos: [
      ...
      fiesta: {
        ...
        imagen: '/trabajos/novias/fiesta/historia_sofia_fiesta.png',
        detallesTecnicos: [
