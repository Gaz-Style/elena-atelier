      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-end p-5 md:p-7 space-y-2 pointer-events-none">
        ...
        <div className="pt-1 w-full pointer-events-auto">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border border-white/20 border-t-white/40 border-l-white/40 border-b-white/10 border-r-white/10 text-white font-sans text-[11px] sm:text-xs uppercase tracking-[0.2em] font-bold bg-white/[0.08] backdrop-blur-[10px] px-4 py-3.5 transition-all duration-[400ms] hover:bg-[#f5f2eb]/90 hover:text-[#121212] hover:border-[#f5f2eb] rounded-[1px] w-full text-center whitespace-nowrap shadow-lg cursor-pointer"
          >
            Cotizar Este Diseño
