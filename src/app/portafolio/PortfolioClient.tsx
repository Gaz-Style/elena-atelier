                ...
                <div key={sIdx} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
                    {items.map((item, idx) => {
                      ...
                      return (
                        <div key={idx} className="relative group overflow-hidden sm:rounded-sm border border-white/10 hover:border-brand-sand/30 transition-all duration-500 w-full">
                          {isVideo ? (
