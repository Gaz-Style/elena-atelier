...
export default function PortalNoviasPage() {
    ...
    if (!isContractAccepted) {
        // RENDER: Formulario de bienvenida (Onboarding)
            ...
            >
                {/* Soft light overlay */}
                <div className="fixed inset-0 bg-[#F5F5F0]/65 z-0 pointer-events-none" />

                <div className="w-full max-w-2xl relative z-10">
                    <div className="text-center mb-12">
                        <div className="flex flex-col items-stretch justify-center w-max mx-auto">
                            <div className="flex justify-between w-full font-serif text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] leading-none">
                                <span>E</span><span>L</span><span>E</span><span>N</span><span>A</span>
                            </div>
                            <div
                                className="font-sans text-[0.65rem] md:text-[0.75rem] font-bold uppercase text-gray-500 mt-1 text-center"
                    ...
                    <div className="bg-white/90 backdrop-blur-md rounded-lg shadow-2xl p-8 md:p-12 border border-[#C17F5F]/20 relative">
                        ...
                        <form onSubmit={handleOnboardingSubmit} className="space-y-10">
                            ...
                            <div className="pt-6 text-center">
                                <button 
                                    type="submit" 
                                    disabled={submitting}
                                    className="w-full bg-[#C17F5F] border border-[#C17F5F] text-white hover:bg-[#a96e51] hover:border-[#a96e51] py-4 rounded text-xs font-bold uppercase tracking-[0.2em] transition-all flex justify-center items-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed group shadow-lg"
                                >
                                    {submitting ? (
    ...
    return (
        <div className="min-h-screen bg-[#F5F5F0] text-[#1A1A1A] font-sans flex flex-col justify-between relative" style={{ backgroundImage: "url('/novia/Novia Elegante 1.webp'), radial-gradient(circle at top, #FFFFFF 0%, #F5F5F0 100%)", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', backgroundRepeat: 'no-repeat' }}>
