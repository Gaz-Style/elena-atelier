...
export default function BridalWelcomePage() {
    ...
    return (
        <div className="min-h-screen bg-[#F5F5F0] text-[#1A1A1A] flex flex-col items-center justify-center p-4 sm:p-8 relative overflow-hidden" style={{ backgroundImage: "url('/novia/Novia%20Elegante%201.webp'), radial-gradient(circle at center, #FFFFFF 0%, #F5F5F0 100%)", backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
            ...
            <div className="w-full max-w-lg mx-auto relative z-20 text-center mt-20 bg-white/40 backdrop-blur-lg p-8 rounded-xl shadow-2xl border border-white/50">
                ...
                <h2 className="font-serif text-3xl md:text-4xl italic text-[#1A1A1A]/90 leading-tight mb-8">
                    Aquí comienza una experiencia exclusiva para ti
                </h2>
