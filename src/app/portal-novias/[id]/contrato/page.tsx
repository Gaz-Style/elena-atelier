...
export default function PortalNoviasContratoPage() {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#F3EFEA] text-[#1A1A1A] font-sans py-12 px-4 md:px-6 relative overflow-hidden print:hidden" style={{ backgroundImage: "url('/novia/Novia Elegante 1.webp')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundAttachment: 'fixed' }}>
                                    ...
                                    {project.payment_plan?.cuotas && project.payment_plan.cuotas.length > 0 ? (
                                        ...
                                        <>
                                            ...
                                            <tr>
                                                ...
                                                <td className="p-3 text-right text-[#4A4A4A]">En prueba intermedia</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td className="p-3 text-right text-[#4A4A4A]">Contra entrega del vestido</td>
                                            </tr>
                                        </>
                                    )}
                ...
                <div className="max-w-xl mx-auto text-center space-y-6">
                    ...
                    <div className="pt-2">
                        {!project.contract_accepted && (
                            <div className="mb-8 p-4 border border-[#C17F5F]/15 bg-white/70 backdrop-blur-md rounded text-left">
