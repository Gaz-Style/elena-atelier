        ...
        <div className="min-h-screen bg-[#0A0A0A] font-sans text-gray-300 flex flex-col relative overflow-hidden">
            <main className="flex-1 w-full max-w-xl mx-auto px-6 py-12 md:py-24 relative z-10 flex flex-col items-center">
                ...
                <div className="mb-12 w-full flex justify-center">
                    <img src="/logotipo.png" alt="Elena La Costurera" className="h-20 w-auto object-contain" />
                </div>
                ...
                <div className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-sm shadow-2xl p-8 md:p-12 relative w-full">
                    ...
                    <div className="text-center mt-6 mb-10 border-b border-white/10 pb-8">
                        <h2 className="font-serif text-2xl text-white mb-3 tracking-wide uppercase">Pago de Reserva</h2>
                    ...
                    {errorMsg ? (
                        <div className="mb-8 p-4 border border-white/20 text-white rounded-sm text-xs text-center flex items-center justify-center gap-2">
                            <span>⚠</span> {errorMsg}
                        </div>
                    ) : links ? (
                        <div className="space-y-10">
                            <div className="text-center">
                                <p className="text-[10px] uppercase tracking-widest text-gray-500 font-bold mb-2">Monto a pagar</p>
                                <p className="text-4xl font-serif text-white tracking-wider">{formatCurrency(links.amount)}</p>
                            </div>
                            ...
                            <div className="space-y-4 pt-4">
                                ...
                                {links.tbkLink && links.tbkToken && (
                                    <form action={links.tbkLink} method="POST" className="w-full">
                                        ...
                                        <button 
                                            type="submit"
                                            className="w-full bg-transparent border border-white/20 hover:bg-white/5 text-white p-5 rounded-sm transition-all duration-300 flex items-center justify-between group"
                                        >
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="text-left">
                                                ...
                                                <span className="text-[9px] text-gray-400 uppercase tracking-widest mt-1 block">Tarjetas o Dinero en cuenta</span>
                                            </div>
                                        </div>
                                        <ArrowRight className="w-4 h-4 text-white group-hover:translate-x-1 transition-transform" />
                                    </a>
                            ...
                            <p className="text-[9px] uppercase tracking-widest text-center text-gray-500 pt-6 border-t border-white/5 flex items-center justify-center gap-2">
