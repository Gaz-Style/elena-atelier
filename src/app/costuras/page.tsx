...
import { ArrowRight, MapPin, Truck, Clock, ShieldCheck, Scissors, Star } from 'lucide-react';

export const metadata: Metadata = {
    title: "Arreglos de Ropa y Sastrería a Domicilio | ELENA",
    description: "Recupera el calce original de tus prendas sin moverte de tu casa. Expertos en trajes, vestidos de fiesta y reparaciones técnicas complejas en Vitacura, Las Condes y Lo Barnechea.",
    openGraph: {
        title: "Arreglos de Ropa y Sastrería a Domicilio | ELENA",
        description: "Recupera el calce original de tus prendas sin moverte de tu casa. Expertos en trajes, vestidos de fiesta y reparaciones técnicas complejas en Vitacura, Las Condes y Lo Barnechea.",
        images: ['/og-image.jpg'],
...
function getWhatsAppUrl(comunaFormatted: string = "[La Dehesa / Los Trapenses / Lo Barnechea / Otro]") {
        ...
        <div className="min-h-screen bg-[#0d0d0d] text-white font-sans relative overflow-hidden pb-20">
            ...
            <header className="max-w-3xl mx-auto px-6 pt-32 pb-16 text-center space-y-6 relative z-10">
                ...
                <div className="space-y-3">
                    <h1 className="font-serif text-4xl md:text-5xl text-white tracking-tight leading-tight font-extrabold">
                        Arreglos de Ropa y Sastrería a Domicilio en Vitacura, Las Condes y Lo Barnechea
                    </h1>
                    <p className="text-white/70 text-sm md:text-base max-w-2xl mx-auto leading-relaxed font-light">
                        Recupera el calce original de tus prendas sin moverte de tu casa. Expertos en trajes, vestidos de fiesta y reparaciones técnicas complejas.
                    </p>
                </div>
                ...
                <div className="flex flex-col items-center justify-center gap-3 pt-2">
                    ...
                    <span className="text-[10px] uppercase tracking-wider text-white/40 flex items-center gap-1">
                        <Clock className="w-3 h-3 text-[#C17F5F]" /> Entregas promedio en 7 días
                    </span>
                </div>
            </header>
            ...
            <section className="max-w-4xl mx-auto px-6 py-12 relative z-10 border-t border-white/5">
                <div className="text-center mb-10 space-y-2">
                    ...
                    <p className="text-xs text-white/50 uppercase tracking-widest">Problemas comunes que solucionamos a domicilio</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="border border-white/5 rounded-sm bg-[#121212] overflow-hidden group">
                        ...
                        <div className="p-5 space-y-2">
                            ...
                            <p className="text-xs text-white/60 leading-relaxed font-light">
                                Ajustamos el calce en trajes, faldas y vestidos.
                            </p>
                        </div>
                    </div>
            ...
            <section className="max-w-3xl mx-auto px-6 py-12 relative z-10 border-t border-white/5">
                <div className="text-center mb-8">
                    <h2 className="font-serif text-lg text-white/60 uppercase tracking-wider">Valores Base Referenciales</h2>
                </div>
            ...
            {/* CTAs DIRECTOS DE WHATSAPP (Tema Oscuro) */}
            <section className="max-w-4xl mx-auto px-6 py-12 relative z-10 border-t border-white/5">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* CTA A */}
