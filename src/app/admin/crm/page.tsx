...
export default async function CRMPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans pb-24">
      ...
      <main className="max-w-7xl mx-auto px-8 pt-16 md:pt-24 space-y-8">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-gray-200 pb-8">
          <div>
            ...
            <h1 className="font-serif text-5xl text-brand-charcoal">Directorio CRM</h1>
            <p className="text-gray-500 mt-2">Gestión de clientas, historial y registro de medidas corporales.</p>
          </div>
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            <div className="relative flex-grow md:flex-grow-0">
              ...
              <input 
                ...
                className="w-full md:w-64 pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-sm focus:outline-none focus:border-brand-terracotta bg-white"
              />
            </div>
            <Link 
              href="/admin/crm/nueva" 
              className="bg-brand-charcoal text-white hover:bg-brand-terracotta px-6 py-2.5 text-xs uppercase tracking-widest font-bold rounded-sm transition-all flex items-center gap-2 whitespace-nowrap"
            >
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200 text-[10px] uppercase tracking-widest text-gray-500 font-bold">
                  <th className="py-4 px-6 font-medium">Nombre Completo</th>
                  <th className="py-4 px-6 font-medium">Contacto</th>
                  <th className="py-4 px-6 font-medium">Estilo / Ocasión</th>
                  ...
                  customers.map((customer) => (
                    <tr key={customer.id} className="hover:bg-gray-50/50 transition-colors group">
                      ...
                      <td className="py-4 px-6 text-right">
                        <button className="text-xs font-bold uppercase tracking-widest text-brand-terracotta hover:text-brand-charcoal transition-colors inline-flex items-center gap-1 opacity-0 group-hover:opacity-100">
