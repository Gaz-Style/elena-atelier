...
const TEMPLATES: Template[] = [
    ...
    { id: 'luxury_contact', emoji: '✨', name: 'Mensaje Luxury',   description: 'Comunicación oficial con estética luxury y fondo.', defaultSubject: 'Mensaje exclusivo desde el Atelier ✨', variables: [
        { key: 'MESSAGE', label: 'Mensaje',        type: 'textarea', default: 'Te escribimos del taller para coordinar los siguientes pasos de tu diseño...' }
    ]},
...
const PREVIEW_HTML: Record<string, string> = {
    ...
    custom: `<!DOCTYPE html><html lang="es"><head><link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700&family=Inter:wght@300;400;600&family=Pinyon+Script&display=swap" rel="stylesheet"><style>body{font-family:'Inter',sans-serif;background:#F0EDE8;margin:0;padding:20px}.c{max-width:420px;margin:0 auto;background:#1A1A1A;border-radius:20px;color:#F5F5F0;padding:30px;text-align:center}.l{font-family:'Playfair Display',serif;font-size:24px;font-weight:900;color:#FFF;letter-spacing:12px;text-transform:uppercase;margin-bottom:8px}.d{border-bottom:1px dashed rgba(255,255,255,.15);margin:20px 0}.t{color:#CECAC2;font-size:13px;line-height:1.6;white-space:pre-line}</style></head><body><div class="c"><a href="https://elenalacosturera.cl" style="text-decoration:none;display:block;color:inherit"><div class="l">ELENA</div><div style="font-size:8px;font-weight:700;color:#FFF;letter-spacing:4px;text-transform:uppercase;margin-bottom:8px">LA COSTURERA</div></a><div class="d"></div><p style="font-size:9px;font-weight:600;color:#C17F5F;letter-spacing:4px;text-transform:uppercase;margin:0 0 20px">Mensaje del Atelier</p><p class="t" style="text-align:left">Estimada {{NAME}},</p><p class="t" style="text-align:left">{{MESSAGE}}</p><div style="margin-top:30px;border-top:1px dashed rgba(255,255,255,.15);padding-top:20px;text-align:center"><p style="font-size:10px;font-weight:600;text-transform:uppercase;letter-spacing:2px;color:#C17F5F;margin:0 0 10px">Es un placer acompañarte en cada detalle</p><p style="font-style:italic;font-size:14px;color:#E5E0D8;margin:0 0 4px">Con cariño,</p><p style="font-family:'Pinyon Script',cursive;font-size:38px;color:#FFF;margin:0 0 4px;font-weight:normal">Elena R.</p></div><p style="font-size:8px;color:#8A857D;letter-spacing:2.5px;margin-top:36px">Av. Tabancura 1091, Oficina 319 · Vitacura</p></div></body></html>`,
    luxury_contact: `<!DOCTYPE html><html lang="es"><head><link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700&family=Inter:wght@300;400;600&family=Pinyon+Script&display=swap" rel="stylesheet"><style>body{font-family:'Inter',sans-serif;background:#F0EDE8;margin:0;padding:20px}.c{max-width:360px;margin:0 auto;background:#1A1A1A;background-image:linear-gradient(to bottom, rgba(26, 26, 26, 0.45) 0%, rgba(26, 26, 26, 0.88) 75%, #1A1A1A 100%), url('/fiesta_gala_opt.jpg');background-size:cover;background-position:center;border-radius:24px;border:1px solid rgba(245, 242, 235, 0.15);color:#F5F5F0;padding:30px;text-align:center}.l{font-family:'Playfair Display',serif;font-size:24px;font-weight:900;color:#FFF;letter-spacing:12px;text-transform:uppercase;margin-bottom:8px}.d{border-bottom:1px dashed rgba(255,255,255,.15);margin:20px 0}.t{color:#CECAC2;font-size:13px;line-height:1.6;white-space:pre-line}</style></head><body><div class="c"><div class="l">ELENA</div><div style="font-size:8px;font-weight:700;color:#FFF;letter-spacing:4px;text-transform:uppercase;margin-bottom:8px">LA COSTURERA</div><div class="d"></div><p style="font-size:8.5px;font-weight:600;color:#C17F5F;letter-spacing:4px;text-transform:uppercase;margin:0 0 20px">Mensaje Especial</p><p class="t" style="text-align:left">Estimada {{NAME}},</p><p class="t" style="text-align:left">{{MESSAGE}}</p><div style="margin-top:30px;border-top:1px dashed rgba(255,255,255,.15);padding-top:20px;text-align:center"><p style="font-size:10px;font-weight:600;text-transform:uppercase;letter-spacing:2px;color:#C17F5F;margin:0 0 10px">Es un placer acompañarte en cada detalle</p><p style="font-style:italic;font-size:14px;color:#E5E0D8;margin:0 0 4px">Con cariño,</p><p style="font-family:'Pinyon Script',cursive;font-size:38px;color:#FFF;margin:0 0 4px;font-weight:normal">Elena R.</p></div><p style="font-size:8px;color:#8A857D;letter-spacing:2.5px;margin-top:36px">Av. Tabancura 1091, Oficina 319 · Vitacura</p></div></body></html>`,
