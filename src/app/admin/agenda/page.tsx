...
export default async function AgendaPage({
    ...
    searchParams: Promise<{ date?: string, view?: string, search?: string }>
}) {
    ...
    async function addEventoManual(formData: FormData) {
        ...
        try {
            ...
            if (tipo === 'cliente') {
                ...
                // 2. Enviar correo + WhatsApp al cliente y dueños (via lib/agenda)
                ...
                <div className="max-w-6xl mx-auto w-full">
                    ...
                    <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 mb-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 items-center">
                            <AgendaSearchBar view={view} selectedDateStr={selectedDateStr} initialSearch={search} />
