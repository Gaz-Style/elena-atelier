...
export default function PortalFiestaContratoPage() {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#F5F5F0] text-[#1A1A1A] font-sans py-12 px-4 md:px-6 relative overflow-hidden print:hidden" style={{ backgroundImage: "url('/novia/fondo_fiesta.webp'), radial-gradient(circle at center, #FFFFFF 0%, #F5F5F0 100%)", backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundAttachment: 'fixed' }}>
                                        ...
                                        {project.payment_plan?.cuotas && project.payment_plan.cuotas.length > 0 ? (
                                            ...
                                            <>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="p-3 text-right text-gray-600">Contra entrega de la prenda</td>
                                                </tr>
                                            </>
                                        )}
