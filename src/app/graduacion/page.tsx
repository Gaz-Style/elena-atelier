...
export default function GraduationLandingPage() {
    ...
    return (
        <div className="min-h-screen bg-brand-charcoal text-white font-sans selection:bg-[#cda45e] selection:text-black">
            ...
            {/* Título SEO. Compacto en móvil para que el catálogo y el vestido Clara Celeste caigan arriba del pliegue */}
            <div className="pt-4 md:pt-24 pb-1 md:pb-6">
                <div className="text-center px-4 md:px-6">
                    <span className="text-[9px] md:text-[10px] uppercase tracking-[0.35em] md:tracking-[0.45em] font-semibold text-brand-sand block mb-1 animate-fade-in">Temporada de Gala 2026</span>
                    <h1 className="font-serif text-2xl md:text-6xl font-bold uppercase tracking-tight text-white">
